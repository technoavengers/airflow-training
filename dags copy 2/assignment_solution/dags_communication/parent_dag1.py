...
with DAG(dag_id="parent_dag1", default_args=default_args, schedule_interval="@daily",tags=['dag_communication']) as dag:
    

    download_file_s3 = BashOperator(
        task_id="download_file_s3",
        bash_command='echo "Downloading File from S3" && sleep 10',
    )
